                ...
                <ol class="inline-flex space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span
                                class="ms-1 text-lg font-medium text-gray-500 md:ms-2 dark:text-gray-400">استایلیست‌ها</span>
                        </div>
                    </li>
                </ol>
            </nav>
...
<div class="mb-4 border-b border-gray-200 dark:border-gray-700">
    <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-tab" data-tabs-toggle="#default-tab-content" role="tablist">
        ...
        <li class="me-2" role="presentation">
            <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="settings-tab" data-tabs-target="#settings" type="button" role="tab" aria-controls="settings" aria-selected="false">نظرات (۳۰)</button>
        </li>
        <li class="me-2" role="presentation">
            <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="settings-tab" data-tabs-target="#education" type="button" role="tab" aria-controls="education" aria-selected="false">تحصیلات</button>
        </li>
                        ...
                        <div class="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
                            ...
                            <div class="col-span-4 sm:col-span-9">
                                <div id="default-tab-content">
                                    ...
                                    <div class="hidden bg-white shadow rounded-lg p-6" id="settings" role="tabpanel" aria-labelledby="settings-tab">
